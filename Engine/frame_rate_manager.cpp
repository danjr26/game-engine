...
FrameRateManager::FrameRateManager(double i_fps) :
	mTimeStepper(1.0 / i_fps),
	mNTrackedFrames(60),
	mNBackedUp(0),
	mMaxBackedUp(0) {
...
void FrameRateManager::setFPS(double i_fps) {
	mTimeStepper.mStep = 1.0 / i_fps;
}
...
void FrameRateManager::setDt(double i_dt) {
	mTimeStepper.mStep = i_dt;
}
