...
public:
	AxisAlignedHalfSpace2CollisionMask(const AxisAlignedHalfSpace<T, 2>& in_halfSpace, bool in_ignoreTransform = false);
	...
	AxisAlignedHalfSpace2CollisionMask<T>* Clone() const override;
