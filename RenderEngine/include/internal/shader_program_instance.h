...
public:
	ShaderProgramInstance(ShaderProgram* i_program);
	void assignUniform(UniformType i_type, const std::string& i_name, const void* i_value);
	void removeUniform(const std::string& i_name);
	void use();
};
